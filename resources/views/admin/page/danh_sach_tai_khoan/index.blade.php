                    ...
                    <div class="modal-dialog modal-lg">
                        <div class="modal-content">
                            ...
                            <div class="modal-footer">
                                ...
                                <button type="button" class="btn btn-primary" v-on:click="themTaiKhoan()">Save
                                    changes</button>
                            </div>
                        </div>
                    </div>
                                            ...
                                            <tr class="align-middle">
                                                ...
                                                <td class="text-center">
                                                    <button v-on:click="doiTrangThaiBlock(value)"
                                                        ...
                                                        style="width: 150px">Chưa Kích Hoạt</button>
                                                    <button v-on:click="doiTrangThaiBlock(value)" v-else
                                                        class="block btn btn-primary" style="width: 150px">Đã Kích
                                                        Hoạt</button>
                                                </td>
                                                <td class="text-center">
                                                    <button v-on:click="doiTrangThai(value)" v-if="value.tinh_trang == 0"
                                                        class="status btn btn-danger">Chưa Hoạt Động</button>
                                                    <button v-on:click="doiTrangThai(value)" v-else
                                                        class="status btn btn-primary">Đang Hoạt Động</button>
                                                </td>
                                                <td class="text-center">
                                                    ...
                                                    <button type="button" class="btn btn-outline-dark"
                                                        v-on:click="tt_xoa = value" data-bs-toggle="modal"
                                                        data-bs-target="#deleteModal"><i
                                                            class="bx bx-trash-alt me-0"></i></i>
                                                    </button>
                                                </td>
                                            </tr>
                                        </template>
                                    ...
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            <div class="row">
                                                <div class="col">
                                                    <label class="mb-2">Email</label>
                                                    <input v-model="tt_cap_nhat.email" type="email"
                                                        class="form-control mb-2" placeholder="Nhập vào Email">
                                                </div>
                                                <div class="col">
                                                    <label class="mb-2">Mật Khẩu</label>
                                                    <input v-model="tt_cap_nhat.password" type="text"
                                                        class="form-control mb-2" placeholder="Nhập vào mật khẩu">
                                                </div>
                                            </div>
                                            <div class="row">
                                                <div class="col">
                                                    <label class="mb-2">Họ Và Tên</label>
                                                    <input v-model="tt_cap_nhat.ho_va_ten" type="text"
                                                        class="form-control mb-2" placeholder="Nhập vào họ và tên">
                                                </div>
                                                <div class="col">
                                                    <label class="mb-2">Số Điện Thoại</label>
                                                    <input v-model="tt_cap_nhat.so_dien_thoai" type="tel"
                                            ...
                                            <div class="row">
                                                <div class="col">
                                                    <label class="mb-2">Ngày Sinh</label>
                                                    <input v-model="tt_cap_nhat.ngay_sinh" type="date"
                                        ...
                                        <div class="modal-footer">
                                            ...
                                            <button v-on:click="capNhatTaiKhoan()" type="button" class="btn btn-primary"
