...
<body>
                        ...
                        <div class="col">
                            <div class="account__login">
                                ...
                                <div class="account__login--inner">
                                    ...
                                    <label>
                                        <input v-model="account.password" class="account__login--input" placeholder="Nhập vào mật khẩu"
                                            type="password">
                                    </label>
                                    <label>
                                        <input v-model="account.re_password" class="account__login--input" placeholder="Nhập lại mật khẩu"
                                            type="password">
                                    </label>
    ...
    <script>
        new Vue({
            ...
            methods: {
                doiMatKhau() {
                    this.account.id    =   $("#id").val();
                    axios
                        .post('{{ Route("ChangePassword") }}', this.account)
                        .then((res) => {
                            if(res.data.status) {
